...
using HDMS.Windows.Forms.UI.Store;
using System;
...
namespace HDMS.Windows.Forms.UI
{
    public partial class StoreMainForm : Form
    {
        ...
        public StoreMainForm(LoginUser user)
        {
            InitializeComponent();
            LoggedinUser = user;
        }
        ...
        private void newProductEntryMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmNewProductEntry());
        }

        private void createGroupToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmStoreProductGroupEntry());
        }
    }
}
