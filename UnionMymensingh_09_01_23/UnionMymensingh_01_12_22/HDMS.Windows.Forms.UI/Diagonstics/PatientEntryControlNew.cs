...
{
    public partial class PatientEntryControlNew : UserControl
    {
        ...
        private void PatientEntryControlNew_Load(object sender, EventArgs e)
        {
            HideAllDefaultHidden();
