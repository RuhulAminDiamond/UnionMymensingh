...
{
    public partial class frmInvestigationEntry : Form
    {
        public static LoginUser LoggedinUser { get; set; }


        public frmInvestigationEntry()
        {
            InitializeComponent();
        ...
        private void frmInvestigationEntry_Load(object sender, EventArgs e)
        {
            TabPage page1 = new TabPage("View 1");
            PatientEntryControl02032019 control1 = new PatientEntryControl02032019();
            ...
            PatientEntryControl02032019 control2 = new PatientEntryControl02032019();
            ...
            PatientEntryControl02032019 control3 = new PatientEntryControl02032019();
