...
{
    public partial class PatientEntryControl : UserControl
    {
        ...
        public PatientEntryControl()
        {
            ...
            lblRecievedByValue.Text = PatientEntry.LoggedinUser.Name;
       ...
       public void ctlTestSearch_ItemSelected(Controls.SearchResultListControl<Model.TestItem> sender, Model.TestItem item)
        ...
        {
            lblTotalPatientsValue.Text = new PatientService().GetNumberofPatient(PatientEntry.LoggedinUser).ToString();
        }
        ...
        private void HandleNewTestAddedActivity(long _PatientId, double newtestcost, double newdiscount, double newpaidtk, double _balance)
        {
            ...
            if (String.IsNullOrEmpty(_message))
            {
                if (result == DialogResult.Yes)
                {
                    ...
                    patient.Updateby = PatientEntry.LoggedinUser.UserId;
                    ...
                    foreach (DataGridViewRow row in dgTests.Rows)
                    {
                        ...
                        if (selectedTests.AdditionType.ToLower() == "new")
                        {
                            ...
                            tCost.DiscountInPercent = "";
                            tCost.Discount = "";
                            tCost.ReportStatus = "";
                            tCost.Status = "";
                            tCost.UserId = PatientEntry.LoggedinUser.UserId;
                            testsCost.Add(tCost);
                    ...
                    pLedger.OperateBy = PatientEntry.LoggedinUser.Name;
        ...
        private void ShowCashMemo2(long _PatientId)
        {
            int _index = 0;
            bool isDue = false;
            ...
            ds = new DataSet();
            ds = new ReportService().GetCashMemo(_PatientId);
                ...
                try
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                      ...
                      //  Patient _patient = new PatientService().GetPatientByBillNo(_billNo);
                        ...
                        patient.Isfree = false;
                        patient.UserId = PatientEntry.LoggedinUser.UserId;
        ...
        private void ShowCashMemo3(long _PatientId)
        {
            int _index = 0;
            bool isDue = false;
            bool isDiscounted = false;
        ...
        private void ShowCashMemo(long _PId)
        {
            ...
            string p1 = string.Empty, p2 = string.Empty, p3 = string.Empty;
            ds = new DataSet();
            ds = new ReportService().GetCashMemo(_PId);
        ...
        private void LoadPrevoiusPatientInfo(long _PId)
        {
            ...
            else
            {
                ...
                {
                    DataSet ds = new ReportService().GetCashMemo(_PatientInfo.PatientId);
        ...
        private void btnPrevId_Click(object sender, EventArgs e)
        {
            ...
            {
                _patient = new PatientService().GetLastReceivedPatientByUser(PatientEntry.LoggedinUser.UserId);
            }else
            {
                long _billNo = 0;
        ...
        private void btnNextId_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(txtPrevBill.Text))
            {
                _patient = new PatientService().GetFirstReceivedPatientByUser(PatientEntry.LoggedinUser.UserId);
            }
            else
            {
                long _billNo = 0;
        ...
        private void PreviewCashMemo(long _PId)
        {
            int _index = 0;
            bool isDue = false;
            bool isDiscounted = false;
