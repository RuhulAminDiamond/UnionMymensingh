...
namespace HDMS.Windows.Forms.UI.Diagonstics
{
    public class Code128bBarcode
    {
        ...
        public static MemoryStream CreateBarcode128b(string input)
        {
            ...
            StreamReader sr = new StreamReader(assembly.GetManifestResourceStream("HDMS.Windows.Forms.UI.Diagonstics.Code128bBarcode.txt"));
        ...
        {
            // Get assembly info
            Assembly assembly = Assembly.GetAssembly(typeof(Code128bBarcode));
