...
using HDMS.Windows.Forms.UI.Accounting;
...
{
    public partial class MISAccount : Form
    {
        public static LoginUser LoggedinUser{get; set;}
        public MISAccount(LoginUser user)
        {
            InitializeComponent();
            LoggedinUser = user;
        }
        ...
        {
            ShowChildForm(new frmAccountHead());
        }
        ...
        {
            ShowChildForm(new AccReportVoucherReport());
        }

        private void trialBalanceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new AccReportTrailBalance());
        }

        private void groupTrialBalanceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new AccReportBalanceSheet());
        }
    }
}
