...
{
    public partial class MISMainForm : Form
    {
        public static LoginUser LoggedinUser{get; set;}
        public MISMainForm(LoginUser user)
        {
            InitializeComponent();
            LoggedinUser = user;
        }
        ...
        private void dailyStatementToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmGroupTestWiseDailyStatement _frmds = new frmGroupTestWiseDailyStatement();
            _frmds.Show();
        }

        private void departmentEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmDepartmentEntry());
        ...
        private void companyEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ShowChildForm(new frmCompanyInfo());

        }

        private void toolStripMenuItem1_Click_1(object sender, EventArgs e)
        {
            ShowChildForm(new frmOrganigationInfo());
          
        }

        private void toolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmBusinessUnit());
