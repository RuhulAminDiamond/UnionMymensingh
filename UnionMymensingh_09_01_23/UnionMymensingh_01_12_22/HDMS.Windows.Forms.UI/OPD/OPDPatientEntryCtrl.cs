...
{
    public partial class OPDPatientEntryCtrl : UserControl
    {
        bool unlocked = true;
        ...
        private void OPDPatientEntryCtrl_Load(object sender, EventArgs e)
        {
        ...
        {
            List<OPDServiceGroup> _sgroup = new HospitalService().getOpdServiceGroups().Where(x => x.GroupId != 17).ToList();
        ...
        private void btnPrevId_Click(object sender, EventArgs e)
        {
            ...
            if (_patient != null)
            {
                ...
                LoadServiceTypeExceptOutDoorOPDConsultation(_patient.GroupId);
