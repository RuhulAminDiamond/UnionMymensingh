...
{
    public partial class frmCreateOPDPackage : Form
    {
        public frmCreateOPDPackage()
        {
            InitializeComponent();
        }

        private void frmCreateOPDPackage_Load(object sender, EventArgs e)
        {
            TabPage page1 = new TabPage("OPD Patient");
            ctrlCreateOPDPackage control1 = new ctrlCreateOPDPackage();
        ...
        private void FillSaleViewPage(TabPage page1, ctrlCreateOPDPackage control1)
        {
