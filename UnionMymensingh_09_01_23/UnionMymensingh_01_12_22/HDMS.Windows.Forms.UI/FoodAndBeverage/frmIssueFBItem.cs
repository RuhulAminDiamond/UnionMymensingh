...
{
    public partial class frmIssueFBItem : Form
    {
        ...
        private void txtQty_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                if (txtInvoiceNo.Tag != null)
                {
                    ...
                    {
                        new FoodAndBeverageItemService().PopulateSelectedItemData(_SelectedItems, txtProduct.Tag as StoreProductInfo, Convert.ToDouble(txtRate.Text), Convert.ToDouble(txtQty.Text));
        ...
        private void AddNewInvoice()
        {
            ...
            if (_InvoiceId > 0)
            {
                ...
                //masterVoucher.VoucherDate = dtpInvData.Value;
                //masterVoucher.VTime = dtpInvData.Value.ToString("hh:mm tt");
                //masterVoucher.VoucherID = "";
                //masterVoucher.VoucherType = "Debit";
                //masterVoucher.Desccription = "Inventory Expense";
                ...
                if (_invce != null)
                {
                    txtInvoiceNo.Text = _invce.InvoiceNumber;
                ...
                foreach (DataGridViewRow row in dgItems.Rows)
                {
                    ...
                    //detailsVoucher.reamrks = selectedTests.Name + " " + selectedTests.Qty.ToString() + " " + "Issued.";
                    ...
                    //                         Convert.ToDouble(selectedTests.Rate);
                    //detailsVoucher.AccId = selectedTests.CreditAccId;
                    //detailsVoucher.reamrks = selectedTests.Name+" "+ selectedTests.Qty.ToString()+" "+"Issued.";
        ...
        private void ShowInvoice(long _InvoiceId)
        {
            ...
            _rpt.SetParameterValue("IssueDept", _issueDept);
        ...
        private void dgRequisitionList_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgRequisitionList.Rows)
            {
                ...
                new FoodAndBeverageItemService().PopulateSelectedItemDataForIssueAgainstRequisition(_SelectedItems, selectedItem);
