...
{
    public partial class ctrlMR : UserControl
    {
        ...
        private void FillListGrid(List<VMIPDInfo> _lisPatientInfo)
        {
            ...
            foreach (VMIPDInfo item in _lisPatientInfo)
            {
                ...
                row.Tag = item;
                row.Height = 30;
                row.CreateCells(dgPatient, item.AdmissionId,item.Name, item.AddmissionDate.ToString("dd/MM/yyyy"), item.AdmTime, item.BedCabinNo,item.RecommededDateForDischarge,item.RecommededTimeForDischarge,item.DischargeRecommendationConfirmedby,item.AssignedDoctor,item.RefDoctor);
        ...
        private void CalculateBill(List<VMHpFinalBill>  _finalBillItems,double serviceCharge)
        {
            ...
            //double _serviceCharge = _total * 0.07;
            ...
            txtAdmissionFee.Text = _admissionFee.ToString();

            double _gtotal = _total + _serviceCharge- _admissionFee;
        ...
        private void btnBillSave_Click(object sender, EventArgs e)
        {
            ...
            VMIPDInfo _pInfo = ((VMIPDInfo)btnBillSave.Tag);
            HospitalPatientInfo _PInfo = new HospitalService().GetHospitalPatientByBillNo(_pInfo.BillNo);
        ...
        private async void GenerateBill(string _billType)
        {
            ...
            if (btnBillSave.Tag != null && !String.IsNullOrEmpty(lblName.Text))
            {
                ...
                VWHpEndPointDataCarrier carrierDataObj = new VWHpEndPointDataCarrier();

            
                carrierDataObj.HpIPDSaleAccountId = 0;
                carrierDataObj.HpOPDOrEmergencySaleAccountId = 0;
                carrierDataObj.HpIPDDiscountAccId = 0;
                carrierDataObj.HpOPDOrEmergencyDiscountAccId = 0;
                carrierDataObj.HpIPDReceivableAccId = 0;
                carrierDataObj.HpOPDOrEmergencyReceivableAccId = 0;
                carrierDataObj.HpIPDCashAccId = 0;
                carrierDataObj.HpOPDOrEmergencyCashAccId = 0;
                carrierDataObj.HpIPDAdvanceAccountId = 0;
                carrierDataObj.MobilePayment = 0;
                carrierDataObj.CardPayment = 0;
                carrierDataObj.CashPaidAmount = 0;
                carrierDataObj.HpOPDOrEmergencyAdvanceAccountId = 0;
                carrierDataObj.UserName = MainForm.LoggedinUser.Name;
                DateTime _transactionDateTime = Utils.GetServerDateAndTime();
                carrierDataObj.TransactionDate = _transactionDateTime;
                carrierDataObj.TransactionTime = _transactionDateTime.ToString("hh:mm tt");
                carrierDataObj.WorkStationId = MainForm.WorkStationId;
                ...
                if (_pInfo != null)
                {
                    ...
                    //long _hbillId = new HpFinancialService().SaveHpFinalBill(_hbill);
                        ...
                        carrierDataObj.hbilldetails = _hbilldetailList;
                        ...
                        carrierDataObj.AdvancePaidAmount = _advancePaidTk;
                        carrierDataObj.CashPaidAmount = cashpaidTk;
                        carrierDataObj.AdmissionFee = _AdmissionFee;
                    ...
                    VMHospitalBillCarrierObj2 _savedObj = await new HpFinancialService().SaveAndGetHpFinalBill(carrierDataObj);

                    ViewPrintView(_savedObj.SavedHpBill.HospitalBillId, _savedObj.billType, _savedObj.Cabin.CabinNo);
        ...
        private void CalculateFinalBill()
        {
          ...
          .Sum(t => Convert.ToInt32(t.Cells[4].Value)).ToString();
            ...
            double _serviceCharge =  _total * 0.00; ;

           // _serviceCharge = _serviceCharge - _disc;

           txtServiceCharge.Text = _serviceCharge.ToString();

            txtGtotal.Text = ((_total + _serviceCharge)-( _disc+_admissionFee)).ToString();

            txtDue.Text = (((_total - (_advancePaid  + _cardormobpaid + _cashpaid) + _serviceCharge))- (_disc+_admissionFee)).ToString();
        ...
        {
            pnlPatient.Location = new Point(15, 10);
        ...
        private void SetPatientMinView()
        {
            ...
            pnlPatient.Location = new Point(pnlPatient.Location.X + 1150, pnlPatient.Location.Y);
