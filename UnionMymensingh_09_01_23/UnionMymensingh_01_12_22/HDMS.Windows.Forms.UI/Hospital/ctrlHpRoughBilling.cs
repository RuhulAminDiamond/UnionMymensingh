...
{
    public partial class ctrlHpRoughBilling : UserControl
    {
        WaitWnd.WaitWndFun waitForm = new WaitWnd.WaitWndFun();

        public ctrlHpRoughBilling()
        {
            InitializeComponent();
            UpdateFont();
        }
        ...
        private void FillBillGrid(List<VMHpFinalBill> finalBillItems)
        {
            ...
            {
                //_serviceCharge = _serviceCharge + (item.Total * 7) / 100;
        ...
        private void txtPaid_TextChanged(object sender, EventArgs e)
        {
            ...
            txtDue.Text = ((_total + _serviceCharge) - (_PaidTk + _advancePaid + _AdmissionFee)).ToString();
        ...
        private async Task<bool> GenerateRoughBill(string _billType,string _msg)
        {
            ...
            if (btnBillSave.Tag != null && !String.IsNullOrEmpty(lblName.Text))
            {
                ...
                if (_pInfo != null)
                {
                    ...
                    int _PCId = 0;
                    PaymentChannel _pChannel = cmbPaymentTerminal.SelectedItem as PaymentChannel;
                    if (_pChannel != null)
                    {
                        ...
                        if (_hbilldetailList.Count > 0)
                        {
                            if (new HpFinancialService().SaveHpRoughBillDetail(_hbilldetailList))
                            {
                                ...
                                if (_prevAdvances != null)
                                {
                                    ...
                                    {
                                        if (_rl.TransactionType.Equals("HpAdvance")|| _rl.TransactionType.Equals("AdvanceByCard")|| _rl.TransactionType.Equals("AdvanceByMob"))
                                        {
                                 ...
                                 if (paidBymobile > 0)
                                {
                                    ...
                                    pLedger.Balance = balance;
                                    pLedger.TransactionType = TransactionTypeEnum.AdvanceByMob.ToString();
                                    pLedger.OperateBy = MainForm.LoggedinUser.Name;
                                    pLedger.TransactionTerminal = MainForm.WorkStationId;
                                    pLedger.PCId = 2;
                                    pLedger.TransactionNo = "";
                                    ...
                                    _advancePayment.PayDate = _tranDate;
                                    _advancePayment.PayTime = _tranTime;
                                    _advancePayment.Amount = paidBymobile;
                                    _advancePayment.ReceievedBy = MainForm.LoggedinUser.Name;
                                    _advancePayment.Remarks = "Advance Payment";
                                    _advancePayment.TransactionTerminal = MainForm.WorkStationId;
                                    _advancePayment.PCId = _PCId;
                                    _advancePayment.TransactionNo = "";
                                    _advancePayment.TransactionType = TransactionTypeEnum.AdvanceByMob.ToString();
                                    new HpFinancialService().SaveAdvancePayment(_advancePayment);
                                ...
                                if (paidByCard > 0)
                                {
                                    ...
                                    pLedger.Balance = balance;
                                    pLedger.TransactionType = TransactionTypeEnum.AdvanceByCard.ToString();
                                    pLedger.OperateBy = MainForm.LoggedinUser.Name;
                                    pLedger.TransactionTerminal = MainForm.WorkStationId;
                                    pLedger.PCId = 3;
                                    pLedger.TransactionNo = "";
                                    ...
                                    _advancePayment.PayDate = _tranDate;
                                    _advancePayment.PayTime = _tranTime;
                                    _advancePayment.Amount = paidByCard;
                                    _advancePayment.ReceievedBy = MainForm.LoggedinUser.Name;
                                    _advancePayment.Remarks = "Advance Payment";
                                    _advancePayment.TransactionTerminal = MainForm.WorkStationId;
                                    _advancePayment.PCId = _PCId;
                                    _advancePayment.TransactionNo = "";
                                    _advancePayment.TransactionType = TransactionTypeEnum.AdvanceByCard.ToString();
                                    new HpFinancialService().SaveAdvancePayment(_advancePayment);
        ...
        private void ViewAdvanceReceipt(long _hbillId, string cabinNo)
        {
            ...
            if (_pInfo != null)
            {
                ...
                /**    */
                _moneyReceipt.SetParameterValue("BillNo", _pInfo.BillNo.ToString());
        ...
        private void dgLedger_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dgLedger.SelectedRows.Count != 0)
            {
                ...
                else if (_bInfo.ServiceName.ToLower().Trim() == "admission fee")
                {
                    ViewInPatientCare(_pInfo.BillNo, lblCabin.Text);
                }
            }
        ...
        private void ViewInPatientCare(long billNo, string text)
        {
            ...
            rptAdmissionfee _rptAF = new rptAdmissionfee();
            //_rpt.SetDataSource(ds.Tables[0]);
            _rptAF.SetDataSource(ds.Tables[0]);
         ...
         //   rv.crviewer.ReportSource = _rpt;
            rv.crviewer.ReportSource = _rptAF;
            rv.crviewer.ToolPanelView = ToolPanelViewType.None;
            rv.crviewer.PrintReport();
            rv.Show();
        }
        ...
        private void GenerateAdvanceReturnReceipt(string _billType)
        {
            ...
            if (btnBillSave.Tag != null && !String.IsNullOrEmpty(lblName.Text))
            {
                ...
                if (_pInfo != null)
                {
                    ...
                    _hbill.AdmissionId = _pInfo.AdmissionId;
                    _hbill.BillDate = _tranDate;
                    _hbill.BillTime = _tranDate.ToString("hh:mm tt");
                    _hbill.BillNo = _pInfo.BillNo;
                    _hbill.Remarks = txtRemarks.Text;
                    _hbill.BillType = _billType;
                    _hbill.PreparedBy = MainForm.LoggedinUser.Name;
                    ...
                    if (_hbillId > 0)
                    {
                        ...
                        ViewAdvanceReturnReceipt(_hbillId, _cabinObj.CabinNo);
        ...
        private void ViewAdvanceReturnReceipt(long hbillId, string cabinNo)
        {
            VMIPDInfo _pInfo = ((VMIPDInfo)btnBillSave.Tag);
        ...
        private void cmbPaymentMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_pmode != null)
            {
                ...
                cmbPaymentTerminal.DataSource = _pChannelList;
                cmbPaymentTerminal.DisplayMember = "Name";
                cmbPaymentTerminal.ValueMember = "PCId";

                if (_pmode.PMId == 1 || _pmode.PMId == 4 || _pmode.PMId == 5)
                {

                    cmbPaymentTerminal.SelectedItem = _pChannelList.Find(q => q.PMId == _pmode.PMId);
        ...
        private void cmbPaymentTerminal_SelectedIndexChanged(object sender, EventArgs e)
        {
            PaymentMode _pmode = cmbPaymentMode.SelectedItem as PaymentMode;
            if (_pmode != null)
            {
        ...
        private void cashRecByCardOrMob(object sender, EventArgs e)
        {
            CalculateRoughBill();
        }

        private void CalculateRoughBill()
        {
            string _tDebit = dgLedger.Rows.Cast<DataGridViewRow>()
            .Sum(t => Convert.ToInt32(t.Cells[4].Value)).ToString();
