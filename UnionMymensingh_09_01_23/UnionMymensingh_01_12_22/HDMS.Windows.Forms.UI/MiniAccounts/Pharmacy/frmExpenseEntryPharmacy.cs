...
{
    public partial class frmExpenseEntryPharmacy : Form
    {
        public frmExpenseEntryPharmacy()
        {
            InitializeComponent();
            UpdateFont();
        }
        ...
        {
            List<VMExpense> expenseList = new MiniAccountService().GetAllExpensesByDate(_date,3);
