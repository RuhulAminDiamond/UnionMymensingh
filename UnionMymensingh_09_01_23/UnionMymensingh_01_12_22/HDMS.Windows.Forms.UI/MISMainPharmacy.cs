...
{
    public partial class MISMainPharmacy : Form
    {
        public static LoginUser LoggedinUser{get; set;}
        public MISMainPharmacy(LoginUser user)
        {
            InitializeComponent();
            LoggedinUser = user;
        }
        ...
        {
            ShowChildForm(new frmAddGroup());
        }

        private void subGroupEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmSubGroup());
        }

        private void genericEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmGeniric());
        }

        private void formattionEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmFormation());
        }

        private void strengthEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmStrength());
        }

        private void manufacturerEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmManufacturer());
        }
    }
}
