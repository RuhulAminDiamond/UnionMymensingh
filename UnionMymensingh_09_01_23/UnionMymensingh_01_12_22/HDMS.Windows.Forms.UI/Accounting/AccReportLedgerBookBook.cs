...
{
    public partial class AccReportLedgerBookBook : Form
    {
        public AccReportLedgerBookBook()
        {
            InitializeComponent();
        }
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            rptACC_Ledger_Book _rpt = new rptACC_Ledger_Book();
            ...
            _rpt.SetParameterValue("@AccountHeadID", AccountHeadID);
