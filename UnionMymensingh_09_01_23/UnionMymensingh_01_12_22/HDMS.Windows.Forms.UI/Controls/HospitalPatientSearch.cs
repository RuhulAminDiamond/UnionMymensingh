...
{
    public partial class HospitalPatientSearch : SearchResultListControl<VMIPDInfo>
    {
        public HospitalPatientSearch()
        {
            InitializeComponent();
        }
        ...
        {
            lvItem.Text = item.AdmissionId.ToString();
        ...
        {
            return new HospitalService().GetCurrentIPDAndOPDInfo();
        }
