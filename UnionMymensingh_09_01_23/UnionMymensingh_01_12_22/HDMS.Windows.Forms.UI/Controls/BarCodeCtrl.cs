...
namespace DSBarCode
{
	public class BarCodeCtrl : System.Windows.Forms.UserControl
	{
		...
		public String mycode = "123456";
        public String testLabel = string.Empty;
        public String patientInfo = string.Empty;
		...
		{
			get { return mycode; }
			set { mycode = value.ToUpper(); panel1.Invalidate(); }
		}

        public String TestLabel
        {
            get { return testLabel; }
            set { testLabel = value.ToUpper(); panel1.Invalidate(); }
        }

        public String PatientInfo
        {
            get { return patientInfo; }
            set { patientInfo = value.ToUpper(); panel1.Invalidate(); }
        }

        public String DateAndTime
        {
            get { return dateTime; }
            set { dateTime = value.ToUpper(); panel1.Invalidate(); }
        }
        ...
        public Font BarcodeFont
        {
            ...
            set { barcodeFont = value; panel1.Invalidate(); }
        }
		...
		private void panel1_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			String str = '*'+ mycode.ToUpper()+'*';
			int strLength=str.Length;
			for ( int i=0;i< mycode.Length ;i++ ) 
			{
				if (alphabet39.IndexOf(mycode[i])==-1 || mycode[i] == '*')
				{
			...
			SizeF fSize = e.Graphics.MeasureString(mycode, footerFont);
            ...
            if (true)
            {
                e.Graphics.DrawString(mycode, barcodeFont, Brushes.Black, footerX, yTop);
                yTop += 15;
                e.Graphics.DrawString(testLabel, footerFont, Brushes.Black, footerX-50, yTop);
                yTop += 15;
                e.Graphics.DrawString(patientInfo, footerFont, Brushes.Black, footerX-50, yTop);
                yTop += 15;
                e.Graphics.DrawString(dateTime, footerFont, Brushes.Black, footerX-50, yTop);
            }
