...
{
    public partial class CtrlPhProductSearchByGeneric : SearchResultListControl<VWPhProductList>
    {
        protected override void FillListColumns(ListView view)
        {
            ...
            header2.Text = "Generic Name";
            header2.TextAlign = HorizontalAlignment.Left;
            header2.Width = 280;


            header3 = new ColumnHeader();
            header3.Text = " Brand Name";
        ...
        {
            return new PhProductService().GetProductListWithStockFilterByGeneric(_filterString);
        }
