...
{
    public partial class SupplierSearchControl : SearchResultListControl<SupplierInfo>
    {
        ...
        {
            return new SupplierService().GetAllSupplier();
        }

        protected override IList<SupplierInfo> GetItemsByType(string _type)
        {
            return new SupplierService().GetSupplierByCategory(_type);
        }
