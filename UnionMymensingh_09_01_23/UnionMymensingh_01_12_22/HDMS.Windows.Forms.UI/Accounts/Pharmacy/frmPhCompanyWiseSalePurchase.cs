...
{
    public partial class frmPhCompanyWiseSalePurchase : Form
    {
        public frmPhCompanyWiseSalePurchase()
        {
            InitializeComponent();
        }
        ...
        private void btnSummaryReport_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new PhProductService().GetPhCompanyWiseDailySalePurchase(dtpfrm.Value,dateto.Value);

            //int c = dsReports.Tables[0].Rows.Count;

            rptPhDailySalePurchase rpt = new rptPhDailySalePurchase();
            ...
            rpt.SetParameterValue("dateto", dateto.Value.ToString(customFmts));
