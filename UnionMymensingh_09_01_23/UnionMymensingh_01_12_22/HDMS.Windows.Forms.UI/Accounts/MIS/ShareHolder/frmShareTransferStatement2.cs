...
{
    public partial class frmShareTransferStatement2 : Form
    {
        public frmShareTransferStatement2()
        {
            InitializeComponent();
        }
        ...
        private void btnShowStatement_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new ShareHolderService().GetShareTransferStatement2(_fiscalYear);

            rptShareTransfer2 _rpt = new rptShareTransfer2();
        ...
        private void frmShareTransferStatement2_Load(object sender, EventArgs e)
        {
