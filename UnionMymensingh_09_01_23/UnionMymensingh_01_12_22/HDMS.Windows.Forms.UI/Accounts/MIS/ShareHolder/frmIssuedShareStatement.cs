...
{
    public partial class frmIssuedShareStatement : Form
    {
        public frmIssuedShareStatement()
        {
            InitializeComponent();
        }
        ...
        private void btnShowStatement_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new ShareHolderService().GetIssuedShareStatement(_fiscalYear);

            rptIssuedandExtraPurchaseShare _rpt = new rptIssuedandExtraPurchaseShare();
