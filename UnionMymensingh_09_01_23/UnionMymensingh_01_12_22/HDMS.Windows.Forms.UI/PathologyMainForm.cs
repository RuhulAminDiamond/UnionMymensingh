...
{
    public partial class PathologyMainForm : Form
    {
        public static LoginUser LoggedinUser{get; set;}
        public PathologyMainForm(LoginUser user)
        {
            InitializeComponent();
            LoggedinUser = user;
        }
        ...
        private void testReportOrderToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowChildForm(new frmTestReportSettings());
        }
    }
